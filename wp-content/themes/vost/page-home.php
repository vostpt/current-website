...
//informação sobre vost
$infovost = get_field('vost_info');
$coluna1title = get_field('coluna1')['titulo_coluna1'];
$coluna1desc = get_field('coluna1')['desc_col1'];
$coluna2title = get_field('coluna2')['titulo_coluna2'];
$coluna2desc = get_field('coluna2')['desc_col2'];
$coluna3title = get_field('coluna3')['titulo_coluna3'];
$coluna3desc = get_field('coluna3')['desc_col3'];
...
//ULTIMOS POSTS
$ultimosposts = get_field('titulo_posts');
$ultimosdesc = get_field('desc_posts');
...
<section class="topcontent">
  ...
  <div class="topcontent__info">
    ...
    <p class="subtitle"><?php echo $desctheader; ?></p>
  </div>
</section>
<!-- main content -->
  ...
  <div class="projectinfo__wrap withmargins">
    ...
    <div class="projectinfo__sections">
      ...
      <div class="section">
        ...
        <div class="section__title"><?php echo $coluna1title; ?></div>
        <div class="section__description"><?php echo $coluna1desc; ?></div>
      </div>
      <!--missao -->
      <div class="section">
        <div class="section__image"><?php echo $missaosvg; ?></div>
        <div class="section__title"><?php echo $coluna2title; ?></div>
        <div class="section__description"><?php echo $coluna2desc; ?></div>
      </div>
      <!--objectivo-->
      <div class="section">
        <div class="section__image"><?php echo $objectivosvg; ?></div>
        <div class="section__title"><?php echo $coluna3title; ?></div>
        <div class="section__description"><?php echo $coluna3desc; ?></div>
      </div>
    </div>
  </div>
</section>
...
<section class="destaque">
  ...
  <div class="destaque__wrap withmargins">
    <div class="title"><?php echo $titledestaque; ?></div>
    <div class="freecontent"><?php echo $artigodestaque; ?> </div>
